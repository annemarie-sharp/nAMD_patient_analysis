---
title: "Exploring Age-related Macular Degeneration Patient Characteristics (Moorfields Eye Hospital)"
...
ggplot(unique_by_sex, aes(x = sex, y = unique_patient_id, fill=sex)) + 
  geom_col() +
  labs (
    title = "Sex Distribution of Age-related Macular Degeneration Patients",
    x = "Sex",
...
distinct_age %>%
  ...
  geom_col() +
  labs(
     title = "Age Group Distribution of Age-related Macular Degeneration Patients",
